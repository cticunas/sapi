...
<div style="padding:10px 20px 10px 10px">
      ...
      <a-form-model style="display:flex; width:100%; gap: 15px;padding:8px; background:#333;color:white">
        ...
        <a-button title="Exportar" type="primary" icon="file-word" @click="fetch({format:'word'})"></a-button>
        </div>
      </a-form-model>
