...
<body style="width:3000px">
  ...
  <table border="solid" style="font-size:15px;">
    <tr><td colspan="17" ><b>Universidad Nacional Agraria de la Selva</b></td></tr>
    <tr><td colspan="17" ><b>Unidad de Investigacion de la UNAS</b></td></tr>
    @foreach($data as $d)
  ...
  <tr>
      <td colspan="17" style="font-size:16px;background-color:#eeeeee "><b>{{$college['org']}}</b></td>
  </tr>
