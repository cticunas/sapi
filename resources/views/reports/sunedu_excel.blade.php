<table>
    <tr>
        <td colspan="19" align="center" style="background-color: grey;"><b>Universidad Nacional Agraria de la Selva</b>
        </td>
    </tr>
    <tr><td colspan="19" align="center">Unidad de Investigacion de la UNAS</td></tr>
    @foreach($data as $d)
    ...
    @foreach($data as $j=>$college)
        <tr><td colspan="19"><b>{{$college['org']}}</b></td></tr>
